...
var roles = [
	...
	{
		rolename: 'forest spirit',
		alignment: 'town investigative',
		abilities: ['Visit someone and chat with them, creating a memory.',
			    'Check the memories of a dead player.'],
		attributes: [
			'You may use both of your abilities in the same night. If you do, you will create a memory with the first player you target, and check the memories of the second player you target.',
			'If your dead target was visited by someone you have a memory of, you will know.',
			'You know which players with memories visited the dead player you selected.',
		],
		targeting: ['living other', 'dead other'],
		goal: towngoal,
		color: towncolor,
		custom: true,
	},
	...
	// TOWN KILLING CUSTOM
	{
		...
		attributes: [
			...
			'You cannot ignite N1, nor can you ignite twice in a row.',
		],
		day_targeting: ['living other'],
		targeting: ['self notfirst'],
		goal: towngoal,
		color: towncolor,
		custom: true,
	},
	...
	{
		rolename: 'ambusher rework',
		alignment: 'mafia killing',
		attack: 'Basic',
		abilities: ['When taking the gunpoint, you may choose to instead Ambush at a player\'s house.'],
		attributes: [
			'Your identity is not revealed when you Ambush.',
			'You gain detection immunity when Ambushing.',
			'You will not kill a Mafia member when Ambushing.',
			'You may Ambush at a Mafia member\'s house.',
		],
		targeting: ['living other'],
		goal: mafiagoal,
		color: mafiacolor,
	...
	{
		rolename: 'godfather rework',
		alignment: 'mafia killing',
		attack: 'Basic',
		defense: 'Basic',
		abilities: ['When taking the gunpoint, your appear not to visit to the Lookout, Spy, or Tracker.'],
		attributes: [
			'You know what roles visit your Mafia members.',
			'You won\'t know which roles visited which Mafia members.',
			'You appear innocent to the Sheriff.',
		],
		targeting: ['living nonmafia'],
		goal: mafiagoal,
		color: mafiacolor,
	...
	{
		rolename: 'mafioso rework',
		alignment: 'mafia killing',
		attack: 'Basic',
		abilities: ['When taking the gunpoint, select a second player and mark them.'],
		attributes: [
			'If the gunpoint targets a marked target, they gain Control, Detection, and Roleblock immunity that night.',
			'Marks last for one night.',
			'All members of the Mafia know who is marked.',
		],
		targeting: ['living nonmafia'],
		goal: mafiagoal,
		color: mafiacolor,
	...
	},
	{
		...
		alignment: 'mafia killing',
		attack: 'Basic',
		abilities: ['When taking the gunpoint, players you kill will become puppets until the next night.'],
		attributes: [
			'Puppets appear to be alive, but are not. They appear to be counted for voting totals, but do not.',
			'Any player that visits a puppet the following night will act as if they were visiting a player in the graveyard. If their ability does not normally target a player in the graveyard, their ability will fail.',
			'If a puppet is lynched, the role and will of the puppet will be revealed, and then voting time will begin again.',
		],
		targeting: ['living nonmafia'],
		goal: mafiagoal,
		color: mafiacolor,
	},
	{
		...
		alignment: 'mafia killing',
		attack: 'Basic',
		abilities: ['When taking the gunpoint, if your target doesn\'t die, they are injured.'],
		attributes: [
			'Injured players cannot have their defense raised above their natural defense.',
			'Injured players are not aware they are injured.',
			'After you injure a player, your lose your detection immunity.',
		],
		targeting: ['living nonmafia'],
		goal: mafiagoal,
		color: mafiacolor,
	...
	{
		rolename: 'stormcaller',
		alignment: 'coven evil',
		attack: 'Basic',
		abilities: ['Summon a rainstorm at one player\'s house each night, drenching your target and all visitors.',
			    'Summon a hurricane, attacking any drenched players who go outside that night.'],
		attributes: [
	...
	},
	{
		...
		alignment: 'coven evil',
		attack: 'Basic',
		abilities: ['You may Possess a player and morph them as another player at night.'],
		attributes: [
			'You will attack the Possessed player if they visit your second target.',
			'Possessed players will have different results to Sheriffs, Investigators, Lookouts, Trackers, and Consiglieres.',
	...
	},
	{
		rolename: 'rifter',
		alignment: 'neutral evil',
		abilities: ['You may Morph someone as another role at night.'],
		attributes: ['You have a Time Barrier that grants you Basic Defense until you are attacked.',
			     'Morphs last 2 nights and will fool Sheriffs, Investigators, Psychics, Spies, and Trappers..',
			     'Morphs will change a player\'s role upon death and when lynched.',
			     'You will the identity of anyone that attacks you.'],
		targeting: ['living other'],
		goal: 'Survive to see the Town lose the game.',
		color: '#008094',
		custom: true,
	...
	},
	{
		...
		attributes: ['You will learn your target\'s role at the beginning of the night.',
			     'You must send a notification to your target. If you do not send one, they will be notified of being roleblocked.',
			     'You may send any message, including role specific messages.'],
		day_targeting: ['living other'],
		goal: 'Survive to see the Town lose the game.',
		color: '#FF69B4',
		custom: true,
	...
	},
	{
		...
		attack: 'None',
		defense: 'Basic',
		abilities: ['Mark one player each night for burial.'],
		attributes: [
			'Marks are permanent. Players will not know that they were marked.',
		...
		targeting: ['living other'],
		goal: 'Successfully bury two players and become Death.',
		color: '#A00000',
		custom: true,
	},
	{
		...
		attack: 'Powerful',
		defense: 'Invincible',
		abilities: ['You may kill a player at night.'],
		attributes: [
			'After the second night you transform, you will be able to kill 2 players every night.',
			'After the third night you transform, you will bury anyone you kill.',
			'After burying 2 players, you transform into Death, Horseman of the Apocalypse.',
		],
		targeting: ['living other', 'living other'],
		goal: 'Successfully bury two players and become Death.',
	...
	},
	{
		...
		attack: 'None',
		defense: 'Basic',
		abilities: ['Learn from one player each night.'],
		attributes: [
			'You have a chainmail garment that grants you Basic Defense until you are attacked.',
			'If your target dies or is lynched the next day, you inherit their role and win condition.',
			'After learning from two players that cannot win together, you can choose to become a Knight during the day.',
		],
		day_targeting: ['self'],
		targeting: ['living other'],
		goal: 'Inherit another player\'s role or become a Knight and win the game.',
		color: '#CCCCCC',
		custom: true,
	},
	{
		...
		attack: 'Basic',
		defense: 'Basic',
		abilities: ['Attack one player each night.'],
		attributes: [
			'Anyone that visits your target will be roleblocked the following night.',
			'You can choose to activate Stealth Mode during the day, making you Roleblock Immune, Control Immune, and your visit being Astral, but in exchange of losing your Defense for the night (single use).',
		],
		day_targeting: ['self'],
		targeting: ['living other'],
		goal: 'Kill all who oppose your rule.',
		color: '#505050',
		custom: true,
	},
